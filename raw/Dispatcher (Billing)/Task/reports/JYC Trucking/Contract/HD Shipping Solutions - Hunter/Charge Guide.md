...
customer: HD Shipping Solutions - Hunter
carrier: JYC Trucking (carlos@jyctrucking.com)
updated: 2026-06-01
---

# Charge Guide — HD Shipping Solutions - Hunter (JYC Trucking)
...
| redelivery | flat — $540 (1x) | extra delivery attempt | manual |
...
- **redelivery** — Redelivery. *(inferred)*
...
**redelivery** — 1/1 sets · $540(1x) · manual
...
|---|---|---|---|---|---|---|
| JYCT_M108308 | IMPORT | PAID | $1620.6 | 6 | Andrea | no |

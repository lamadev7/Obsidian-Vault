...
customer: ADVIK INC - Clint
carrier: JYC Trucking (carlos@jyctrucking.com)
updated: 2026-06-01
---

# Charge Guide — ADVIK INC - Clint (JYC Trucking)
...
|---|---|---|---|
| Base Price | flat per move — $400 (1x) | the lane (load itself) | manual |
| PrePull | flat — $120 (1x) | pull date vs last-free-day | manual |
| bonded_cargo_charge | flat — $125 (1x) | bonded move flag | manual |
| drop_charge | confirm — $150 (1x) | confirm source | manual |
| SPLIT CHASSIS | per day — $75 (1x) | days the chassis is held | manual |
| pier_pass | flat pass-through — $77.56 (1x) | pass-through (port receipt) | manual |
...
| reefer | confirm — $100 (1x) | confirm source | manual |
...
**Base Price** — 1/1 sets · $400(1x) · manual

> Loads: JYCT_E108381

**PrePull** — 1/1 sets · $120(1x) · manual

> Loads: JYCT_E108381

**bonded_cargo_charge** — 1/1 sets · $125(1x) · manual

> Loads: JYCT_E108381

**drop_charge** — 1/1 sets · $150(1x) · manual
...
**pier_pass** — 1/1 sets · $77.56(1x) · manual
...
|---|---|---|---|---|---|---|
| JYCT_E108381 | EXPORT | PAID | $1656.96 | 12 | Andrea | no |

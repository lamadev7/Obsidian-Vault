...
customer: FREIGHT FLOW SOLUTIONS - PAUL
carrier: JYC Trucking (carlos@jyctrucking.com)
updated: 2026-06-01
---

# Charge Guide — FREIGHT FLOW SOLUTIONS - PAUL (JYC Trucking)
...
| Base Price | flat per move — $650 (1x) | the lane (load itself) | manual |
...
**Base Price** — 1/1 sets · $650(1x) · manual
...
|---|---|---|---|---|---|---|
| JYCT_E107801 | EXPORT | PAID | $899.2 | 7 | Luciano | no |

...
customer: Allmodes Logistics Consultancy
carrier: JYC Trucking (carlos@jyctrucking.com)
updated: 2026-06-01
---

# Charge Guide — Allmodes Logistics Consultancy (JYC Trucking)
...
- Load types: EXPORT:2.
- Biggest manual charge: **PORT DETENTION (3)** — #1 conversion target.
...
|---|---|---|---|
| Base Price | flat per move — $650 (2x) | the lane (load itself) | manual |
| Chassis | per day — $50 (2x) | days the chassis is held | manual |
| EMPTY LOAD STORAGE | per day — $50 (2x) | empty dwell days | manual |
...
| other | unknown — $162.5 (1x) | unknown | manual |
...
**Base Price** — 2/2 sets · $650(2x) · manual

> Loads: JYCT_E107683, JYCT_E108503

**Chassis** — 2/2 sets · $50(2x) · manual

> Loads: JYCT_E107683, JYCT_E108503

**EMPTY LOAD STORAGE** — 2/2 sets · $50(2x) · manual
...
**PORT DETENTION** — 2/2 sets · $70(3x) · manual

> Loads: JYCT_E107683, JYCT_E108503

**PrePull** — 1/2 sets · $150(1x) · manual

> Loads: JYCT_E108503

**YARD STORAGE** — 1/2 sets · $50(1x) · manual
...
**other** — 1/2 sets · $162.5(1x) · manual
...
|---|---|---|---|---|---|---|
| JYCT_E107683 | EXPORT | PAID | $941.5 | 7 | Andrea | no |
| JYCT_E108503 | EXPORT | PAID | $1122.9 | 12 | Andrea | no |
